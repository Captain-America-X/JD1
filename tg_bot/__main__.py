...
Join my [Support channel](https://t.me/svmmbots) to get information on all the latest updates.
"""
...
""".format(dispatcher.bot.first_name, "" if not ALLOW_EXCL else "If you have any bugs or questions on how to use me, have a look at my [Group](https://t.me/svmmbotssuports), or head to @svmmbots.")

DONATE_STRING = """Heya, glad to hear you want to donate!
It took lots of work for [my creator](t.me/Captain_America_X) to get me to where I am now, and every donation helps \
motivate him to make me even better. All the donation money will go to a better VPS to host me, and/or beer \
(see his bio!). He's just a poor student, so every little helps!
[Donate](t.me/Captain_America_X)."""
